...
from mot.AB3DMOT_libs.model import AB3DMOT
from AB3DMOT_libs.kitti_utils import  compute_box_3d, draw_projected_box3d, Calibration
...
class DemoDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None, search_id='0000',ext='.bin'):
        """
        Args:
            root_path:
            dataset_cfg:
...
def parse_config():
    ...
    parser.add_argument('--data_path', type=str, default='../tracking_dataset',
                        help='specify the point cloud data file or directory')
    parser.add_argument('--ckpt', type=str, default='../tracking_dataset/final.pth', help='specify the pretrained model')
...
def detection_and_tracking(points,cfg,args,logger=None,search_id=None):
    data_dict = {}
    ...
    with torch.no_grad():
        for index, data_dict in enumerate(demo_dataset):
            ...
            for object in objects:
                print("%d %s %f %f %f %f %f %f %f %f\n" % (object.id, object.type, object.score, object.t[0], object.t[1], object.t[2], object.h, object.w, object.l, object.ry))
